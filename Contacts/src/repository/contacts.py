...
async def get_contacts(filter: str | None, skip: int, limit: int, db: Session) -> List[Contact]:
...
async def get_contacts_by_birthdays(skip: int, limit: int, db: Session) -> Contact:
